...
VALUES
    ...
    (500, '10d', 'Rain', 'Light rain', 'Lluvia ligera', 'rainlow.png', '#858585', '#0373b8'),
    (501, '10d', 'Rain', 'Moderate rain', 'Lluvia moderada', 'rainmoderate.png', '#858585', '#0373b8'),
    (502, '10d', 'Rain', 'Heavy intensity rain', 'Lluvia de intensidad fuerte', 'rain.png', '#858585', '#0373b8'),
    (503, '10d', 'Rain', 'Very heavy rain', 'Lluvia muy intensa', 'rainheavy.png', '#858585', '#0373b8'),
    (504, '10d', 'Rain', 'Extreme rain', 'Lluvia extrema', 'rainheavy.png', '#858585', '#0373b8'),
    (511, '13d', 'Rain', 'Freezing rain', 'Lluvia helada', 'rainheavy.png', '#858585', '#0373b8'),
    (520, '09d', 'Rain', 'Light intensity shower rain', 'Lluvia de intensidad ligera', 'rainlow.png', '#858585', '#0373b8'),
    (521, '09d', 'Rain', 'Shower rain', 'Lluvia de ducha', 'rainmoderate.png', '#858585', '#0373b8'),
    (522, '09d', 'Rain', 'Heavy intensity shower rain', 'Lluvia de ducha de intensidad fuerte', 'rain.png', '#858585', '#0373b8'),
    (531, '09d', 'Rain', 'Ragged shower rain', 'Lluvia de ducha desgarrada', 'rainheavy.png', '#858585', '#0373b8'),
	(500, '10n', 'Rain', 'Light rain', 'Lluvia ligera', 'rainlow.png', '#858585', '#0373b8'),
	(501, '10n', 'Rain', 'Moderate rain', 'Lluvia moderada', 'rainmoderate.png', '#858585', '#0373b8'),
	(502, '10n', 'Rain', 'Heavy intensity rain', 'Lluvia de intensidad fuerte', 'rain.png', '#858585', '#0373b8'),
	(503, '10n', 'Rain', 'Very heavy rain', 'Lluvia muy intensa', 'rainheavy.png', '#858585', '#0373b8'),
	(504, '10n', 'Rain', 'Extreme rain', 'Lluvia extrema', 'rainheavy.png', '#858585', '#0373b8'),
	(511, '13n', 'Rain', 'Freezing rain', 'Lluvia helada', 'rainheavy.png', '#858585', '#0373b8'),
	(520, '09n', 'Rain', 'Light intensity shower rain', 'Lluvia de intensidad ligera', 'rainlow.png', '#858585', '#0373b8'),
	(521, '09n', 'Rain', 'Shower rain', 'Lluvia de ducha', 'rainmoderate.png', '#858585', '#0373b8'),
	(522, '09n', 'Rain', 'Heavy intensity shower rain', 'Lluvia de ducha de intensidad fuerte', 'rain.png', '#858585', '#0373b8'),
	(531, '09n', 'Rain', 'Ragged shower rain', 'Lluvia de ducha desgarrada', 'rainheavy.png', '#858585', '#0373b8'),
    ...
    (800, '01d', 'Clear', 'Clear sky', 'Cielo despejado', 'sunny.png', '#fb970f', '#ffc94f'), 
    (800, '01n', 'Clear', 'Clear sky', 'Cielo despejado', 'starrynight.png', '#00587d', '#33d6ff'),
    (801, '02d', 'Clouds', 'Few clouds: 11-25%', 'Pocas nubes: 11-25%', 'cloudy1.png', '#fb970f', '#ffc94f'), 
