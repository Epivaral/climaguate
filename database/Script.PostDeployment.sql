...
('BANANO','Banano','Banana',26,30,75,85,15,38,'["1","2","3","12"]','["1","2","3","12"]','High',50,365,1,
 'Planta herbácea perenne de gran porte, de la familia Musaceae. Produce frutos alargados y comestibles, ricos en potasio, que crecen en racimos.',
 'assets/BANANO.png'),
('PLATANO','Plátano','Plantain',26,30,75,85,15,38,'["1","2","3","12"]','["1","2","3","12"]','High',45,365,1,
 'Planta herbácea tropical, similar al banano, pero sus frutos se consumen cocidos. Es básico en la alimentación de regiones tropicales.',
 'assets/PLATANO.png'),
...
('AGUACAT','Aguacate','Avocado',18,25,60,75,10,32,'["1","2","3"]','["8","9","10"]','Medium',30,365,1,
 'Árbol perennifolio de la familia Lauraceae, originario de Mesoamérica. Su fruto es una drupa comestible rica en grasas saludables.',
 'assets/AGUACAT.png'),
...
('PITAHAY','Pitahaya','Dragon Fruit',18,30,40,60,5,38,'["2","3"]','["6","7"]','Low',10,180,1,
 'Cactácea trepadora originaria de América, apreciada por sus frutos exóticos y nutritivos.',
 'assets/PITAHAY.png'),
...
('CACAHUET','Cacahuete','Groundnut',22,30,50,70,10,35,'["5","6"]','["8","9"]','Medium',20,120,1,
 'Sinónimo de maní, planta anual de la familia Fabaceae, cultivada por sus semillas oleaginosas.',
 'assets/CACAHUET.png')
