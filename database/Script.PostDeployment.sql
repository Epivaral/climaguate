...
('ESC','Escuintla',14.3050,-90.7850,346,'Acrisol', 'Aw'),
('MAZ','Mazatenango',14.5347,-91.5050,365,'Fluvisol','Aw'),
('ZAC','Zacapa',14.9722,-89.5308,220,'Fluvisol','Aw'),
('PUE','Puerto Barrios',15.7277,-88.5945,5,'Fluvisol','Af'),
('SLC','Santa Lucía Cotzumalguapa',14.3347,-91.0264,275,'Fluvisol','Aw'),
('JUT','Jutiapa',14.2906,-89.8958,900,'Regosol','Aw'),
('RET','Retalhuleu',14.5361,-91.6778,240,'Fluvisol','Aw'),
('SAL','Salamá',15.1036,-90.3186,940,'Regosol','Aw'),
('FLO','Flores',16.9254,-89.8923,150,'Fluvisol','Aw'),
('SAN','Sanarate',14.7942,-90.1928,780,'Fluvisol','Aw'),
...
('GST','Guastatoya',14.8536,-90.0694,770,'Fluvisol','Aw'),
('STE','Santa Elena',16.9167,-89.8994,160,'Fluvisol','Aw'),
('CUA','Cuilapa',14.2769,-90.2997,980,'Andosol','Cwa'),
('PAL','Palencia',14.6644,-90.3594,1390,'Andosol','Cwa'),
('ESQ','Esquipulas',14.5667,-89.3500,950,'Fluvisol','Aw'),
...
('PLATANO','Plátano','Plantain',22,28,70,85,15,35,'["1","2","3","12"]','["1","2","3","12"]','High',45,365,1,
 ...
 'assets/PLATANO.png'),
('CARDAM','Cardamomo','Cardamom',18,25,70,85,12,32,'["3","4"]','["11","12"]','High',40,240,1,
...
('MAZ','SESAMO',84,1,2,-5,'Suchitepequez: segundo productor nacional (26% de producción)'),
...
('RET','SESAMO',88,1,2,-5,'Retalhuleu: primer productor nacional (60% de producción)'),
...
-- Zacapa (ZAC)
('ZAC','TOMATE',82,1,3,-5,'Principal cultivo comercial; valles con riego del Motagua'),
('ZAC','MAIZ',76,1,2,-10,'Adaptado con manejo'),
('ZAC','FRIJOL',72,1,1,-10,'Ciclo corto'),
('ZAC','SORGO',78,1,3,-10,'Tolerante a sequía'),
('ZAC','MANGO',78,0,2,0,'Frutal de calor; amplia producción local'),
('ZAC','NARANJ',72,0,1,0,'Cítricos con riego'),
('ZAC','SESAMO',72,0,3,-5,'Se cultiva pero no es zona primaria; Retalhuleu lidera producción'),
('ZAC','MANI',70,0,2,-5,'Maní de secano'),
-- Chiquimula (CHQ)
('CHQ','TOMATE',78,1,3,-5,'Cultivo comercial importante; valles orientales con riego'),
('CHQ','MAIZ',75,1,2,-10,'Manejo de humedad'),
('CHQ','FRIJOL',72,1,1,-10,'Ciclo corto'),
('CHQ','SORGO',78,1,3,-10,'Tolerante a sequía'),
('CHQ','MANGO',78,0,2,0,'Frutal de valle oriental'),
('CHQ','NARANJ',70,0,1,0,'Cítricos con riego'),
('CHQ','SESAMO',70,0,3,-5,'Posible pero no zona primaria de producción'),
('CHQ','MANI',72,0,2,-5,'Maní de secano'),
-- Esquipulas (ESQ)
('ESQ','CAFE',90,1,-2,10,'Cultivo principal del municipio; laderas húmedas'),
('ESQ','SESAMO',70,0,3,-5,'Factible en zonas secas; zona primaria es costa sur'),
...
-- Jutiapa (JUT)
('JUT','SESAMO',70,0,2,-5,'Factible; producción nacional liderada por costa sur'),
...
-- Sanarate (SAN)
('SAN','SESAMO',72,0,2,-5,'Factible en zonas secas'),
...
-- Guastatoya (GST)
('GST','SESAMO',72,0,2,-5,'Factible en zonas secas'),
...
('SAL','SESAMO',72,0,2,-5,'Factible en secano'),
